...
namespace Tiro.Health.FormFiller.WebView2.Tests
{
    ...
    public class TestEmbeddedWebAssets
    {
        ...
        // The embedded version manifest is generated by build/web-sdk/copy-bundle.mjs and
        // must parse with a version: it is what the served bundle URL is built from.
        [TestMethod]
